...
UPDATE [UniRu].Settings.SiteOptions SET Value = 'https://VM1APKTEST-P1.gkbaltbet.local:443'
    WHERE Name = 'Global.CKFinderSettings.ImageHost'
-- ELSE
--     INSERT INTO [UniRu].Settings.SiteOptions (GroupId, Name, Value, IsInherited)
--     VALUES (1, 'Global.CKFinderSettings.ImageHost', 'https://VM1APKTEST-P1.gkbaltbet.local:443', 0);  
--------------------------------------------------------------------------------          
...
UPDATE [UniRu].Settings.SiteOptions SET Value = 'https://VM1APKTEST-P1.gkbaltbet.local:13443/st'
    WHERE Name = 'Global.GlobalLog.BaltBetClientStatistics.StatisticsHandlerUrl'
-- ELSE
--     INSERT INTO [UniRu].Settings.SiteOptions (GroupId, Name, Value, IsInherited)
--     VALUES (1, 'Global.GlobalLog.BaltBetClientStatistics.StatisticsHandlerUrl', 'https://VM1APKTEST-P1.gkbaltbet.local:13443/st', 0);  
--------------------------------------------------------------------------------          
...
UPDATE [UniRu].Settings.SiteOptions SET Value = 'https://VM1APKTEST-P1.gkbaltbet.local:4442/'
    WHERE Name = 'Global.MessagesServiceSettings.URL'
-- ELSE
--     INSERT INTO [UniRu].Settings.SiteOptions (GroupId, Name, Value, IsInherited)
--     VALUES (1, 'Global.MessagesServiceSettings.URL', 'https://VM1APKTEST-P1.gkbaltbet.local:4442/', 0);  
--------------------------------------------------------------------------------          
...
UPDATE [UniRu].Settings.SiteOptions SET Value = 'https://VM1APKTEST-P1.gkbaltbet.local:8491/'
    WHERE Name = 'Global.SignalR.Remote.Endpoint'
-- ELSE
--     INSERT INTO [UniRu].Settings.SiteOptions (GroupId, Name, Value, IsInherited)
--     VALUES (1, 'Global.SignalR.Remote.Endpoint', 'https://VM1APKTEST-P1.gkbaltbet.local:8491/', 0);  
--------------------------------------------------------------------------------          
...
UPDATE [UniRu].Settings.SiteOptions SET Value = '172.16.1.217'
    WHERE Name = 'Global.WcfClient.WcfServicesHostAddress'
-- ELSE
--     INSERT INTO [UniRu].Settings.SiteOptions (GroupId, Name, Value, IsInherited)
...
UPDATE [UniRu].Settings.SiteOptions SET Value = 'https://VM1APKTEST-P1.gkbaltbet.local:449/account/logout/last'
    WHERE Name = 'OAuth.LastLogoutUrl'
-- ELSE
--     INSERT INTO [UniRu].Settings.SiteOptions (GroupId, Name, Value, IsInherited)
--     VALUES (1, 'OAuth.LastLogoutUrl', 'https://VM1APKTEST-P1.gkbaltbet.local:449/account/logout/last', 0);  
--------------------------------------------------------------------------------          
                                                                                         
IF EXISTS (SELECT * FROM [UniRu].Settings.SiteOptions
    WHERE Name = 'OAuth.TokenUrl')
UPDATE [UniRu].Settings.SiteOptions SET Value = 'https://VM1APKTEST-P1.gkbaltbet.local:449/oauth/token'
    WHERE Name = 'OAuth.TokenUrl'
-- ELSE
--     INSERT INTO [UniRu].Settings.SiteOptions (GroupId, Name, Value, IsInherited)
--     VALUES (1, 'OAuth.TokenUrl', 'https://VM1APKTEST-P1.gkbaltbet.local:449/oauth/token', 0);  
--------------------------------------------------------------------------------          
